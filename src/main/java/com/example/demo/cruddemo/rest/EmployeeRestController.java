package com.example.demo.cruddemo.rest;
...
import com.example.demo.cruddemo.service.EmployeeService;
...
public class EmployeeRestController {
	...
	// @RequestBody is used to handle binding that JSON over to given object
